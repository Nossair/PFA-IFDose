...
public class ShowCalculActivityfr extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intent2 = new Intent(ShowCalculActivityfr.this, WelcomeActivity.class);
        startActivity(intent2);}

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_show_calcul_fr);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_camera:
                        Intent intent = new Intent(ShowCalculActivityfr.this, WelcomeActivity.class);
                        startActivity(intent);
                        break;

                    case R.id.nav_gallery:
                        Intent intent1 = new Intent(ShowCalculActivityfr.this, ProfileActivity.class);
                        startActivity(intent1);
                        break;

                    case R.id.nav_slideshow:
                        Intent intent2 = new Intent(ShowCalculActivityfr.this, ReportActivity.class);
                        startActivity(intent2);
                        break;

                    case R.id.nav_manage:
                        Intent intent3 = new Intent(ShowCalculActivityfr.this, GlucoseActivity.class);
                        startActivity(intent3);
                        break;

                    case R.id.nav_camera2:
                        Intent intent4 = new Intent(ShowCalculActivityfr.this, MealActivity.class);
...
//            Log.i(TAG, "dx2 : "+dx2);
        ...
        totalegcg.setText(""+c.uc());
        ur.setText(String.format("%.5f", c.ur()));
        System.out.println(String.format("%.5f", c.ur())+"hohi");
    ...
    public void startNotificationAfter4Hours(int page) {
        ...
        Toast.makeText(this,  R.string.bien, Toast.LENGTH_LONG).show();
    }
