...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Pusher p= new Pusher(msg_context,db,sp);
        //p.getRatiofrompusher(resultintent);
        ...
        //int l;
        System.out.println("   mobil  ******************************************************************************************  "+db.getMsgIdserv("mobile"));
        System.out.println("     web  *****************  "+db.getMsgIdserv("web"));
        System.out.println("    demande *********************   "+db.getMsgIdserv("demande"));
        if(db.getMsgIdserv("mobile")!=0 ||db.getMsgIdserv("web")!=0){
            ...
            System.out.println("   *****************         raataaaaaaaaaaaaaaaaaande  l max  "+l);
        }
        if(db.getMsgIdserv("demande")!=0 ){
            System.out.println("     **************       demaaaaaaaaaaaaaaaaaande    ");
            getMsgDemand("LastDemande",db.getMsgIdserv("demande"));

        }
        //getMsgDemand("LastDemande",15);
        //getMsgDemand("retio",48);
        ...
        if (values.length>1)
            addrsip = values[1];
System.out.println("-----------------id---------------------------"+ Locale.getDefault().getLanguage());
